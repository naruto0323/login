...
$app_id   = "1415466918780788";
$app_secret = "196b078bca775181b2e242eec1853a0d";
$site_url = "http://localhost/fb/index.php";
  ...
  if(isset($_POST['publish'])){
    try{
      $publishStream = $facebook->api("/$user/feed", 'post', array(
        'message'   => 'Check out my new login',
        'link'      => 'http://localhost',
        'picture'   => 'http://localhost',
        'name'      => 'login page',
        'caption'   => 'fblogin',
        'description'   => 'A test for facebook login.',
        ));
    }catch(FacebookApiException $e){
      error_log($e);
    }
