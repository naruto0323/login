...
$google_client_id       = '342758403854-eik7vjtaogooooojk3t7bi5hqdg2l84p.apps.googleusercontent.com
';
$google_client_secret   = 'mzeWbgvzeu_u9ngow-KC5kxe
';
$google_redirect_url    = 'http://research.web.iiit.ac.in/~chowduru.ramachandra/google/'; //path to your script
$google_developer_key   = 'xxxxxxxxxxxxxxxxxxxxxxxxxxxxx';

########## MySql details (Replace with yours) #############
$db_username = "a2175789_ram"; //Database Username
$db_password = "iiit123"; //Database Password
$hostname = "localhost"; //Mysql Hostname
$db_name = 'a2175789_login'; //Database Name
###################################################################
